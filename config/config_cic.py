...
import termcolor
import pandas as pd
from dataset.Dataset_cic import Dataset
...
class Config(object):
    ...
    def __init__(self, conf_file_path=None, seed=None, exp_name=None, log=True):
        ...
        dataset_path = r"D:\PythonProject\chatbot\dataset\preprocessed\CSE-CIC-IDS2018\train.csv"
        ...
        try:
            ...
            category_counts = [
                ...
                max(2,int(self.df["is_holiday"].nunique())),  # 计算 `day_of_week`
...
if __name__ == '__main__':
    ...
    cnf = Config(conf_file_path = r"D:\PythonProject\chatbot\config\config\CSE-CIC-IDS2018_Normal.yaml",
                 exp_name="CSE-CIC-IDS2018_Normal")
